...
<title></title>
		<link rel="stylesheet" href="./cytp_files/index.css">
		<script type="text/javascript" src="./cytp_files/jquery-1.x.js.下载"></script>
		<script type="text/javascript" src="./cytp_files/changeH.js.下载"></script>
	...
	<body langeasy="105">
		<div class="main">
			...
			<form action="http://localhost/vote/articleListServlet?flag=search" method="post" target="mainframe">
				<table class="table1">
					<tbody><tr>
						...
						<td width="260px"><img src="./cytp_files/new.gif"> <a href="http://localhost/vote/admin/tpList.jsp" onclick="hi();" target="mainframe">返回列表</a></td>
						<td width="280px"><img src="./cytp_files/addnew.gif"> <a href="http://localhost/vote/admin/addNewtp.jsp" target="mainframe">添加新投票</a></td>
						
							<td width="280px"><img src="./cytp_files/edit.gif"> <a href="http://localhost/vote/articleListServlet?del=d" onclick="hi();" target="mainframe">维护</a><input type="hidden" name="hi" id="hi" value="0"></td>
			...
			<div class="mid">
				...
				<iframe src="cytp_files/tpList.jsp" width="900" id="win" name="mainframe" onload="Javascript:SetWinHeight(this)" frameborder="0" scrolling="no" height="256"></iframe>
