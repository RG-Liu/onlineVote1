        ...
        <div class="mid03">
            ...
            <form action="${pageContext.request.contextPath}/LoginServlet" method="post" onsubmit="return check();">
                <table>
                    <tbody><tr>
                        <td>用户名：</td>
                        <td><input class="intxt" type="text" name="username" id="username"></td>
                    </tr>
                    <tr>
                        <td>密码：</td>
                        <td><input class="intxt" type="password" name="password" id="password"></td>
                    </tr>
                    <tr>
                    
                     <!--  -->   <td>验证码:</td>
                        <td><input type="text" name="vcode"  size="10" />
                        <img src="code" onclick="this.src='code?'+Math.random();"></td>
                    ...
                    <tr>
                        ...
                        <td><a href="admin/reg.jsp">新用户注册</a></td>
                    </tr>
                    </tbody></table>
            </form>
        </div>
