...
<!-- saved from url=(0031)http://localhost/vote/login.jsp -->
...
<div class="main">
  ...
  <div class="mid">
    ...
    <div class="mid03">
      <div class="head">
        用户登录 &nbsp;  <img src="./login_files/arrow_down.gif"> <span style="color: red"></span>
      </div>
      <div class="line1"></div>
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="${pageContext.request.contextPath}/admin/reg.jsp">新用户注册</a>
            </td>
            <font color='red'style="position: absolute; margin-top: -85px; font-size: 20px;">${message}</font>
